...
DATABASES = {
    'default': {
        ...
        'NAME': 'kaizen_base',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 's04c5o_r@sr4nm72+v80$0sh64zi@ksqh!8i5a$=-9wfnewkfy'
...
MIDDLEWARE_CLASSES = (
    ...
    'kaizen.middleware.NoIfModifiedSinceMiddleware',
)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'helper_log': {
            ...
            'formatter': 'verbose',         
            'filename': os.path.join(PROJECT_PATH, 'log', 'helper.log') 
        }
    },
    'loggers': {
        'django.request': {
